...
import com.xfxb.xfshop.service.common.utils.CookieUtils;
 ...
 * @date   2015年11月2日 下午9:51:10
 * @ver    V1.0
 */
public class Page<T> {
	
	private int pageNo = 1; // 当前页码
	private int pageSize = Integer.valueOf(GlobalHelper.getConfig("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
