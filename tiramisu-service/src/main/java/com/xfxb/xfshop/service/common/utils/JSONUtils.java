package com.xfxb.xfshop.service.common.utils;
...
public class JSONUtils extends ObjectMapper {
	...
	public JSONUtils(boolean allowEmpty){
		this(allowEmpty ? Include.USE_DEFAULTS : Include.NON_EMPTY);
	}
	...
	public String toJson(Object object,boolean allowEmpty) {
		try {
			return new JSONUtils(allowEmpty).writeValueAsString(object);
		} catch (IOException e) {
			logger.warn("write to json string error:" + object, e);
			return null;
		}
	...
	public static String toJsonString(Object object,boolean allowEmpty){
		return JSONUtils.getInstance().toJson(object,allowEmpty);
	}
